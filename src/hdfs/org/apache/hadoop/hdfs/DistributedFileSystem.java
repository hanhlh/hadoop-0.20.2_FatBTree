 ...
 * @deprecated */
  ...
  public ArrayList<URI> getUris() { return uris;}

  public void initialize(URI uri, Configuration conf) throws IOException, MessageException {
	  System.out.println("DistributedFileSystem initialize");
    ...
    System.out.println("DFS initialized");
  }
 ...
 * @throws MessageException */
  ...
  private String getPathName(Path file) throws MessageException {
    checkPath(file);
 ...
 * @throws MessageException */
  ...
  public boolean setReplication(Path src,
	  ...
	  StringUtility.debugSpace("DistributedFileSyste.setReplication");
 ...
 * @throws MessageException
   */
  public boolean rename(Path src, Path dst) throws IOException, MessageException {
 ...
 * @throws MessageException
  ...
  public FileStatus[] listStatus(Path p) throws IOException, MessageException {
  ...
  public boolean mkdirs(Path f, FsPermission permission, boolean isDirectory)
  									throws IOException, MessageException {
	  return dfs.mkdirs(getPathName(f), permission, isDirectory);
  }

  public boolean synchronizeRootNodes() throws IOException, ServiceException, MessageException {
	  System.out.println("DistributedFileSystem.synchronizeRootNodes");
	  return dfs.synchronizeRootNodes();
  }
  /** {@inheritDoc} */
 ...
 * @throws MessageException
  ...
  public FileStatus getFileStatus(Path f) throws IOException, MessageException {
	  ...
	  //FileStatus fi = dfs.getFileInfo(getPathName(f), f.isDirectory());
    if (fi != null) {
  ...
  public FileStatus getFileStatus(Path f, boolean isDirectory)
  									throws IOException, MessageException {
	  FileStatus fi = dfs.getFileInfo(getPathName(f), isDirectory);
    if (fi != null) {
      return makeQualified(fi);
    } else {
      throw new FileNotFoundException("File does not exist: " + f);
  ...
  /** {@inheritDoc}
 * @throws MessageException */
  public MD5MD5CRC32FileChecksum getFileChecksum(Path f) throws IOException, MessageException {
 ...
 * @throws MessageException */
  ...
  public boolean transferNamespace(String targetMachine) throws IOException, ClassNotFoundException {
	...
	public boolean resetOffloading() throws IOException, ClassNotFoundException {
		StringUtility.debugSpace("DistributedFileSystem.resetOffloading");
