...
/****************************************************
 * A LocatedBlock is a pair of Block, DatanodeInfo[] and DatanodeInfo
 * objects.  It tells where to find a Block and which DatanodeInfo is
 * managing its metadata (iNode).
 *
 ****************************************************/
public class LocatedBlock implements
									Serializable,
									Writable {
  ...
  @Override
	public String toString() {
		return "LocatedBlock [b=" + b + ", offset=" + offset + ", locs="
				+ Arrays.toString(locs) + ", corrupt=" + corrupt + "]";
	}
  ...
  public void write(DataOutput out) throws IOException {
	  //StringUtility.debugSpace("LoctedBlocks.write");
  ...
  public void readFields(DataInput in) throws IOException {
	  //StringUtility.debugSpace("LoctedBlocks.read");
