 ...
 * with the NameNodeFBT.  User code can manipulate the directory namespace,
 ...
 * @throws MessageException
  ...
  public LocatedBlock append(String src, String clientName) throws IOException,
  												MessageException, ServiceException;

  /**
   * Set replication for an existing file.
   * <p>
   * The NameNodeFBT sets replication to the new value and returns.
 ...
 * @throws MessageException
   */
  public LocatedBlock addBlock(String src, String clientName) throws IOException, MessageException;
 ...
 * @throws MessageException
  ...
  /**
   * Client programs can cause stateful changes in the NameNodeFBT
   ...
   * dies unexpectedly.
   * <p>
   * So, the NameNodeFBT will revoke the locks and live file-creates
   * for clients that it thinks have died.  A client tells the
   * NameNodeFBT that it is still alive by periodically calling
   * renewLease().  If a certain amount of time passes since
   * the last call to renewLease(), the NameNodeFBT assumes the
   * client has died.
   */
