 ...
 */
public class LocatedBlocks implements Writable, Serializable {
  /**
	 *
	 */
	private static final long serialVersionUID = 1L;
	private long fileLength;
	private ArrayList<LocatedBlock> blocks; // array of blocks with prioritized locations
  ...
  public LocatedBlocks(long flength, ArrayList<LocatedBlock> blks, boolean isUnderConstuction) {
   ...
   * Get located blocks.
   */
  public ArrayList<LocatedBlock> getLocatedBlocks() {
    return blocks;
  }
...
public String toString() {
	return "LocatedBlocks [fileLength=" + fileLength + ", blocks=" + blocks.toString()
...
//////////////////////////////////////////////////
  ...
  public void write(DataOutput out) throws IOException {
	  //StringUtility.debugSpace("LocatedBlocks.write");
  ...
  public void readFields(DataInput in) throws IOException {
	  //StringUtility.debugSpace("LocatedBlocks.read");
