...
/**********************************************************************
 * Protocol that a DFS datanode uses to communicate with the NameNodeFBT.
 * It's used to upload current load information and block reports.
 *
 * The only way a NameNodeFBT can communicate with a DataNode is by
...
//batch transfer blocks to a single another datanode
  final static int DNA_TRANSFERS = 7;
  /**
   * Register Datanode.
   *
  ...
  /**
   * sendHeartbeat() tells the NameNodeFBT that the DataNode is still
   * alive and well.  Includes some status info, too.
   * It also gives the NameNodeFBT a chance to return
  ...
  /**
   * blockReport() tells the NameNodeFBT about all the locally-stored blocks.
   * The NameNodeFBT returns an array of Blocks that have become obsolete
  ...
  /**
   * blockReceived() allows the DataNode to tell the NameNodeFBT about
  ...
  /**
   * errorReport() tells the NameNodeFBT about something that has gone
