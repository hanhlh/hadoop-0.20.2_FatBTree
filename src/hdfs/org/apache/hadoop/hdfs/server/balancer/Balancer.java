...
public class Balancer implements Tool {
   ...
   */
  private void init(double threshold) throws IOException, MessageException {
    this.threshold = threshold;
  ...
  private static NamenodeProtocol createNamenode(Configuration conf)
    throws IOException {
    InetSocketAddress nameNodeAddr = NameNodeFBT.getAddress(conf);
   ...
   */
  private OutputStream checkAndMarkRunningBalancer() throws IOException, MessageException, ServiceException {
    try {
