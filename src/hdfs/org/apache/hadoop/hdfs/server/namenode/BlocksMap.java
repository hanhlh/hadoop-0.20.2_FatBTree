 ...
 */
public class BlocksMap implements Serializable {

  /**
   * Internal class for block metadata.
   */
  public static class BlockInfo extends Block implements Serializable {
 ...
 // appended //
    public void setINode(INodeFile i) {
    	inode = i;
    }
    ...
    DatanodeDescriptor getDatanode(int index) {
      ...
      System.out.println("getDatanode "+node);*/
      assert node == null ||
    ...
    BlockInfo getPrevious(int index) {
      ...
      assert info == null ||
          BlockInfo.class.getName().equals(info.getClass().getName()) :
                "BlocksMap is expected at " + index*3;
      return info;
    }
    ...
    private int getCapacity() {
    	//System.out.println("triplets.length "+triplets.length);
      assert this.triplets != null : "BlocksMap is not initialized";
      assert triplets.length % 3 == 0 : "Malformed BlocksMap";
    ...
    int numNodes() {
      ...
      for(int idx = getCapacity()-1; idx >= 0; idx--) {
    	  //System.out.println("numNodes idx "+idx);
  ...
  public BlocksMap(int initialCapacity, float loadFactor) {
    this.capacity = 1;
  ...
  /**
   * Add BlocksMap if mapping does not exist.
   */
   ...
   */
  public BlockInfo addINode(Block b, INodeFile iNode) {
