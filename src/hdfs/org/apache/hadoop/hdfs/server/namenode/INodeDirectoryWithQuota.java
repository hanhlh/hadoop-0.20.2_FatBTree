...
//appended //
  ...
  public INodeDirectoryWithQuota(INodeDirectoryWithQuotaInfo info) {
	  super(info);
	  nsQuota = info.getNsQuota();
	  nsCount = info.getNsCount();
	  dsQuota = info.getDsQuota();
	  diskspace = info.getDiskspace();
  }
}
