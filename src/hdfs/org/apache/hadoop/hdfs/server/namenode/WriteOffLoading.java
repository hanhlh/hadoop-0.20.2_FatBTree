...
public class WriteOffLoading {
	...
	public static final Log LOG = LogFactory.getLog(WriteOffLoading.class.getName());
	 ...
	 public void logAuditEvent(long id, String file, DatanodeDescriptor wolDst,
			 						DatanodeDescriptor dst) {
		    final Formatter fmt = auditFormatter.get();
		    ((StringBuilder)fmt.out()).setLength(0);

		    LOG.info(fmt.format(LOG_FORMAT,id, file, wolDst, dst).toString());

	}

	 public static String writeOffLoadingFile = "./logs/writeOffLoading.log";
	 public static String writeOffLoadingBackUp = "./writeOffLoadingBackUp/";
	 private int id;
	 private String file;
	 private DatanodeDescriptor wolDst;
	 private DatanodeDescriptor dst;
	...
	public DatanodeDescriptor getWolDst() {
		return wolDst;
	}

	public void setWolDst(DatanodeDescriptor wolDst) {
		this.wolDst = wolDst;
	}

	public DatanodeDescriptor getDst() {
		return dst;
	}

	public void setDst(DatanodeDescriptor dst) {
		this.dst = dst;
	}

	public WriteOffLoading (int id, String file, DatanodeDescriptor wolDst,
			 								DatanodeDescriptor dst) {
		this.id = id;
		this.file = file;
		this.wolDst = wolDst;
	...
	public static String createWriteOffLoadingRecord
					(int id, String file, DatanodeDescriptor wolDst, DatanodeDescriptor dst) {
		StringBuilder builder = new StringBuilder();

		builder.append("WOL,");
		builder.append(id + ",");
		builder.append(file + ",");
		builder.append(wolDst.getName() + ",");
		builder.append(dst.getName());
	...
	public void outputRecord (String record) {
		...
		try {
			file = new File(writeOffLoadingFile);
			if (!file.exists())
