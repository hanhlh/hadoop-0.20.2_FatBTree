...
/**********************************************************
 * The Secondary NameNodeFBT is a helper to the primary NameNodeFBT.
 * The Secondary is responsible for supporting periodic checkpoints
 * of the HDFS metadata. The current design allows only one Secondary
 * NameNodeFBT per HDFs cluster.
 *
 * The Secondary NameNodeFBT is a daemon that periodically wakes
 * up (determined by the schedule specified in the configuration),
 * triggers a periodic checkpoint and then goes back to sleep.
 * The Secondary NameNodeFBT uses the ClientProtocol to talk to the
 * primary NameNodeFBT.
 *
 **********************************************************/
public class SecondaryNameNode implements Runnable {
  ...
  /**
   * Copy the new fsimage into the NameNodeFBT
   */
  ...
  void doCheckpoint() throws IOException {
    ...
    //
    // Upload the new image into the NameNodeFBT. Then tell the Namenode
    ...
    if (ErrorSimulator.getErrorSimulation(1)) {
      throw new IOException("Simulating error1 " +
                            "after uploading new image to NameNodeFBT");
    }
  ...
  public static void main(String[] argv) throws Exception {
    ...
    if (argv.length >= 1) {
      ...
      NameNode.LOG.info("SecondaryNameNode.exit "+ret);
      System.out.println("SecondaryNameNode.exit "+ret);
      System.exit(ret);
    }
