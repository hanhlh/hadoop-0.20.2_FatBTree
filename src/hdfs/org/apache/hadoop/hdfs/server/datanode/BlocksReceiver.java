 ...
 **/
class BlocksReceiver implements java.io.Closeable, FSConstants {
  ...
  BlocksReceiver(Block block, DataInputStream in, String inAddr,
  ...
  class PacketResponder implements Runnable, FSConstants {
    ...
    private BlocksReceiver receiver; // The owner of this responder.

    public String toString() {
      return "PacketResponder " + numTargets + " for Block " + this.block;
    }

    PacketResponder(BlocksReceiver receiver, Block b, DataInputStream in,
