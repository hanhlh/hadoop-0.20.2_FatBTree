...
/**
 * 
 * This is the JMX MBean for reporting the NameNodeFBT Activity.
 * The MBean is register using the name
 *        "hadoop:service=NameNodeFBT,name=NameNodeActivity"
 * 
...
public class NameNodeActivtyMBean extends MetricsDynamicMBeanBase {
  ...
  protected NameNodeActivtyMBean(final MetricsRegistry mr) {
    super(mr, "Activity statistics at the NameNodeFBT");
    mbeanName = MBeanUtil.registerMBean("NameNodeFBT", "NameNodeActivity", this);
  }
