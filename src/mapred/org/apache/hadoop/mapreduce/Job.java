...
public class Job extends JobContext {
  ...
  public Job() throws IOException, MessageException {
    this(new Configuration());
  }

  public Job(Configuration conf) throws IOException, MessageException {
    super(conf, null);
    jobClient = new JobClient((JobConf) getConfiguration());
  }

  public Job(Configuration conf, String jobName) throws IOException, MessageException {
    this(conf);
    setJobName(jobName);
  }
 ...
 * @throws MessageException
   * @throws IllegalStateException if the job is submitted
   */
  public void setWorkingDirectory(Path dir) throws IOException, MessageException {
    ensureState(JobState.DEFINE);
 ...
 * @throws MessageException
   */
  public boolean isComplete() throws IOException, MessageException {
    ensureState(JobState.RUNNING);
 ...
 * @throws MessageException
   */
  public boolean isSuccessful() throws IOException, MessageException {
    ensureState(JobState.RUNNING);
 ...
 * @throws ServiceException
   */
  public void killJob() throws IOException, MessageException, ServiceException {
    ensureState(JobState.RUNNING);
    info.killJob();
  }
