 ...
 * @throws MessageException
   */
  void output(K key, V value) throws IOException, MessageException, ServiceException;
 ...
 * @throws MessageException
   */
  void progress(float progress) throws IOException, MessageException, ServiceException;
