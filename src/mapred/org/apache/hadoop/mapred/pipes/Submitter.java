 ...
 * @throws MessageException
   ...
   */
  @Deprecated
  public static RunningJob submitJob(JobConf conf) throws IOException, MessageException, ServiceException {
    return runJob(conf);
  }
 ...
 * @throws MessageException
   */
  public static RunningJob runJob(JobConf conf) throws IOException, MessageException, ServiceException {
    setupPipesJob(conf);
 ...
 * @throws MessageException
   */
  public static RunningJob jobSubmit(JobConf conf) throws IOException, MessageException, ServiceException {
    setupPipesJob(conf);
