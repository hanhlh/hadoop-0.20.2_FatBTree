...
/**
  ...
  public void abortTask(TaskAttemptContext context) throws IOException, MessageException {
    Path taskOutputPath =  getTempTaskOutputPath(context);
    try {
      if (taskOutputPath != null) {
  ...
  Path getTempTaskOutputPath(TaskAttemptContext taskContext) throws MessageException {
