...
public abstract class FileOutputFormat<K, V> implements OutputFormat<K, V> {
  ...
  public void checkOutputSpecs(FileSystem ignored, JobConf job)
    throws FileAlreadyExistsException,
           InvalidJobConfException, IOException, MessageException {
 ...
 * @throws MessageException
   */
  public static void setOutputPath(JobConf conf, Path outputDir) throws MessageException {
 ...
 * @throws MessageException
  ...
  static void setWorkOutputPath(JobConf conf, Path outputDir) throws MessageException {
    outputDir = new Path(conf.getWorkingDirectory(), outputDir);
