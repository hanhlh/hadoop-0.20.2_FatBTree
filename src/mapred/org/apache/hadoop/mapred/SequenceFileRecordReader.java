...
public class SequenceFileRecordReader<K, V> implements RecordReader<K, V> {
  ...
  public synchronized boolean next(K key, V value) throws IOException, MessageException {
  ...
  protected synchronized void seek(long pos) throws IOException, MessageException {
    in.seek(pos);
  }
