...
public class JobConf extends Configuration {
  ...
  public void deleteLocalFiles() throws IOException, MessageException {
  ...
  public void deleteLocalFiles(String subdir) throws IOException, MessageException {
    String[] localDirs = getLocalDirs();
    for (int i = 0; i < localDirs.length; i++) {
 ...
 * @throws MessageException
   */
  public Path getLocalPath(String pathString) throws IOException, MessageException {
 ...
 * @throws MessageException
   */
  public void setWorkingDirectory(Path dir) throws MessageException {
 ...
 * @throws MessageException
   */
  public Path getWorkingDirectory() throws MessageException {
