 ...
 * @throws MessageException
   */
  @Override
  public void localizeConfiguration(JobConf conf) throws IOException, MessageException, ServiceException {
  ...
  private class SkippingReduceValuesIterator<KEY,VALUE>
     ...
     public SkippingReduceValuesIterator(RawKeyValueIterator in,
         ...
         TaskUmbilicalProtocol umbilical) throws IOException, MessageException, ServiceException {
       super(in, comparator, keyClass, valClass, conf, reporter);
     ...
     void nextKey() throws IOException, MessageException, ServiceException {
       super.nextKey();
       mayBeSkip();
     }
     ...
     private void mayBeSkip() throws IOException, MessageException, ServiceException {
     ...
     private void writeSkippedRec(KEY key, VALUE value) throws IOException, MessageException, ServiceException{
       if(skipWriter==null) {
  ...
  public void run(JobConf job, final TaskUmbilicalProtocol umbilical)
    throws IOException, InterruptedException, ClassNotFoundException, MessageException, ServiceException {
    this.umbilical = umbilical;
  ...
  void runOldReducer(JobConf job,
                     ...
                     Class<INVALUE> valueClass) throws IOException, MessageException, ServiceException {
  ...
  static class NewTrackingRecordWriter<K,V>
    ...
    InterruptedException, MessageException, ServiceException {
      real.close(context);
    }

    @Override
    public void write(K key, V value) throws IOException, InterruptedException, MessageException, ServiceException {
  ...
  class ReduceCopier<K, V> implements MRConstants {
    ...
    private class MapOutput {
      ...
      public void discard() throws IOException, MessageException {
        if (inMemory) {
          data = null;
        } else {
     ...
     * @throws ServiceException
      ...
      private long copyOutput(MapOutputLocation loc
                              ) throws IOException, InterruptedException, MessageException, ServiceException {
    ...
    public ReduceCopier(TaskUmbilicalProtocol umbilical, JobConf conf,
                        ...
                        )throws ClassNotFoundException, IOException, MessageException {
    ...
    private RawKeyValueIterator createKVIterator(
        JobConf job, FileSystem fs, Reporter reporter) throws IOException, MessageException, ServiceException {
    ...
    private class InMemFSMergeThread extends Thread {
      ...
      @SuppressWarnings("unchecked")
      private void doInMemMerge() throws IOException, MessageException, ServiceException{
        if (mapOutputsFilesInMemory.size() == 0) {
          return;
        }
