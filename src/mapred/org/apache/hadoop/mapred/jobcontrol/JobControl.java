...
public class JobControl implements Runnable{
  ...
  synchronized private void checkRunningJobs() throws MessageException, ServiceException {
  ...
  synchronized private void checkWaitingJobs() throws MessageException, ServiceException {
    Map<String, Job> oldJobs = null;
  ...
  synchronized private void startReadyJobs() throws MessageException, ServiceException {
    Map<String, Job> oldJobs = null;
