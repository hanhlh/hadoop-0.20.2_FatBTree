 ...
 * @throws MessageException
  ...
  WrappedRecordReader(int id, RecordReader<K,U> rr,
      Class<? extends WritableComparator> cmpcl) throws IOException, MessageException, ServiceException {
    this.id = id;
    this.rr = rr;
    khead = rr.createKey();
 ...
 * @throws MessageException
   */
  public void skip(K key) throws IOException, MessageException, ServiceException {
    if (hasNext()) {
 ...
 * @throws MessageException
   */
  protected boolean next() throws IOException, MessageException, ServiceException {
 ...
 * @throws MessageException
   */
  public boolean next(K key, U value) throws IOException, MessageException, ServiceException {
    if (hasNext()) {
