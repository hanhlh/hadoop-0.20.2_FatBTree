...
public class Parser {
  ...
  static class WNode extends Node {
    ...
    private JobConf getConf(JobConf job) throws MessageException {
    ...
    public ComposableRecordReader getRecordReader(
        InputSplit split, JobConf job, Reporter reporter) throws IOException, IllegalArgumentException, MessageException {
      try {
  ...
  static class CNode extends Node {
    ...
    public ComposableRecordReader getRecordReader(
        InputSplit split, JobConf job, Reporter reporter) throws IOException, MessageException {
