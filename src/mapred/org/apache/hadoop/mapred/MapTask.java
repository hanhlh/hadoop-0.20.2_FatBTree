...
class MapTask extends Task {
  ...
  class SkippingRecordReader<K, V> extends TrackedRecordReader<K,V> {
    ...
    private void writeSkippedRec(K key, V value) throws IOException, MessageException, ServiceException{
      if(skipWriter==null) {
  ...
  public void run(final JobConf job, final TaskUmbilicalProtocol umbilical)
    throws IOException, ClassNotFoundException, InterruptedException, MessageException, ServiceException {
    this.umbilical = umbilical;
  ...
  static class NewTrackingRecordReader<K,V>
    ...
    @Override
    public boolean nextKeyValue() throws IOException, InterruptedException, MessageException {
  ...
  private static class OldOutputCollector<K,V> implements OutputCollector<K,V> {
    ...
    public void collect(K key, V value) throws IOException, MessageException, ServiceException {
      try {
  ...
  private class NewOutputCollector<K,V>
    ...
    NewOutputCollector(org.apache.hadoop.mapreduce.JobContext jobContext,
                       ...
                       TaskReporter reporter
                       ) throws IOException, ClassNotFoundException, MessageException {
  ...
  class DirectMapOutputCollector<K, V>
    ...
    public DirectMapOutputCollector(TaskUmbilicalProtocol umbilical,
        JobConf job, TaskReporter reporter) throws IOException, MessageException, ServiceException {
      this.reporter = reporter;
    ...
    public void collect(K key, V value, int partition) throws IOException, MessageException, ServiceException {
      reporter.progress();
      out.write(key, value);
      mapOutputRecordCounter.increment(1);
    }
  ...
  implements MapOutputCollector<K, V>, IndexedSortable {
    ...
    private void spillSingleRecord(final K key, final V value,
                                   int partition) throws IOException, MessageException, ServiceException {
