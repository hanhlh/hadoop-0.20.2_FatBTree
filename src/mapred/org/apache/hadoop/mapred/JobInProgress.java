 ...
 * @throws MessageException
  ...
  public JobInProgress(JobID jobid, JobTracker jobtracker,
                       JobConf default_conf) throws IOException, MessageException, ServiceException {
    this(jobid, jobtracker, default_conf, 0);
  }

  public JobInProgress(JobID jobid, JobTracker jobtracker,
                       JobConf default_conf, int rCount) throws IOException, MessageException, ServiceException {
 ...
 * @throws MessageException
  ...
  throws IOException, KillInterruptedException, MessageException, ServiceException {
 ...
 * @throws ServiceException
  ...
  public synchronized void updateTaskStatus(TaskInProgress tip,
                                            TaskStatus status) throws MessageException, ServiceException {
 ...
 * @throws ServiceException
   */
  private void jobComplete() throws MessageException, ServiceException {
    final JobTrackerInstrumentation metrics = jobtracker.getInstrumentation();
    //
  ...
  private synchronized void terminateJob(int jobTerminationState) throws MessageException, ServiceException {
    if ((status.getRunState() == JobStatus.RUNNING) ||
        (status.getRunState() == JobStatus.PREP)) {
 ...
 * @throws ServiceException
   */
  private synchronized void terminate(int jobTerminationState) throws MessageException, ServiceException {
    if(!tasksInited.get()) {
  ...
  private void clearUncleanTasks() throws MessageException, ServiceException {
    TaskAttemptID taskid = null;
    TaskInProgress tip = null;
 ...
 * @throws ServiceException
   */
  public void kill() throws MessageException, ServiceException {
 ...
 * @throws ServiceException
   */
  synchronized void fail() throws MessageException, ServiceException {
 ...
 * @throws ServiceException
  ...
  private void failedTask(TaskInProgress tip, TaskAttemptID taskid,
                          ...
                          boolean wasRunning, boolean wasComplete) throws MessageException, ServiceException {
    final JobTrackerInstrumentation metrics = jobtracker.getInstrumentation();
 ...
 * @throws ServiceException
  ...
  public void failedTask(TaskInProgress tip, TaskAttemptID taskid, String reason,
                         ...
                         String trackerName) throws MessageException, ServiceException {
 ...
 * @throws ServiceException
   */
  synchronized void garbageCollect() throws MessageException, ServiceException {
