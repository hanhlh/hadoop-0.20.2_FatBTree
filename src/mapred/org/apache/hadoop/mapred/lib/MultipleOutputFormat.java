...
extends FileOutputFormat<K, V> {
  ...
  public RecordWriter<K, V> getRecordWriter(FileSystem fs, JobConf job,
    ...
    return new RecordWriter<K, V>() {
      ...
      public void write(K key, V value) throws IOException, MessageException, ServiceException {
 ...
 * @throws MessageException
  ...
  abstract protected RecordWriter<K, V> getBaseRecordWriter(FileSystem fs,
      JobConf job, String name, Progressable arg3) throws IOException, MessageException, ServiceException;
}
