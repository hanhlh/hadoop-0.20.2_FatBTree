...
public class MultipleOutputs {
  ...
  private static class RecordWriterWithCounter implements RecordWriter {
    ...
    public void write(Object key, Object value) throws IOException, MessageException, ServiceException {
 ...
 * @throws MessageException
  ...
  public OutputCollector getCollector(String namedOutput, String multiName,
    ...
    return new OutputCollector() {
      ...
      @SuppressWarnings({"unchecked"})
      public void collect(Object key, Object value) throws IOException, MessageException, ServiceException {
        writer.write(key, value);
      }
