...
public class InputSampler<K,V> implements Tool {
  ...
  public interface Sampler<K,V> {
     ...
     */
    K[] getSample(InputFormat<K,V> inf, JobConf job) throws IOException, MessageException, ServiceException;
  }
  ...
  public static class SplitSampler<K,V> implements Sampler<K,V> {
    ...
    public K[] getSample(InputFormat<K,V> inf, JobConf job) throws IOException, MessageException, ServiceException {
 ...
 * @throws ServiceException
  ...
  public static <K,V> void writePartitionFile(JobConf job,
      Sampler<K,V> sampler) throws IOException, MessageException, ServiceException {
