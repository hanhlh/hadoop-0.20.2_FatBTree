 ...
 * @throws MessageException
   */
  synchronized void initialize() throws IOException, MessageException {
 ...
 * @throws MessageException
   */
  public void cleanupStorage() throws IOException, MessageException {
  ...
  private class FetchStatus {
    ...
    public boolean fetchMapCompletionEvents(long currTime) throws IOException, MessageException {
  ...
  private void localizeJob(TaskInProgress tip) throws IOException, MessageException, ServiceException {
  ...
  private void launchTaskForJob(TaskInProgress tip, JobConf jobConf) throws IOException, MessageException, ServiceException{
    synchronized (tip) {
  ...
  public synchronized void shutdown() throws IOException, MessageException {
    shuttingDown = true;
    close();
    if (this.server != null) {
      try {
 ...
 * @throws MessageException
   */
  public synchronized void close() throws IOException, MessageException {
    //
 ...
 * @throws MessageException
   */
  public TaskTracker(JobConf conf) throws IOException, MessageException {
    originalConf = conf;
 ...
 * @throws ServiceException
   */
  private HeartbeatResponse transmitHeartBeat(long now) throws IOException, MessageException, ServiceException {
 ...
 * @throws MessageException
   */
  private synchronized void purgeJob(KillJobAction action) throws IOException, MessageException {
 ...
 * @throws MessageException
   */
  long tryToGetOutputSize(TaskAttemptID taskId, JobConf conf) throws MessageException {
  ...
  class TaskInProgress {
    ...
    private void localizeTask(Task task) throws IOException, MessageException, ServiceException{
     ...
     * @throws MessageException
     */
    public synchronized void launchTask() throws IOException, MessageException, ServiceException {
    ...
    void reportTaskFinished() throws MessageException {
      taskFinished();
      releaseSlot();
    }
     ...
     * @throws MessageException
     */
    public void taskFinished() throws MessageException {
 ...
 * @throws MessageException
   */
  void reportTaskFinished(TaskAttemptID taskid, boolean commitPending) throws MessageException {
    TaskInProgress tip;
    synchronized (this) {
      tip = tasks.get(taskid);
    }
  ...
  private synchronized List<TaskStatus> cloneAndResetRunningTaskStatuses(
                                          boolean sendCounters) throws MessageException {
  ...
  private Path[] getLocalFiles(JobConf conf, String subdir) throws IOException, MessageException{
