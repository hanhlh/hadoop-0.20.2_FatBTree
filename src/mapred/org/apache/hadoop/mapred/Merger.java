...
class Merger {
  ...
  public static class Segment<K extends Object, V extends Object> {
    ...
    public Segment(Configuration conf, FileSystem fs, Path file,
                   CompressionCodec codec, boolean preserve) throws IOException, MessageException {
    ...
    private void init(Counters.Counter readsCounter) throws IOException, MessageException {
      if (reader == null) {
  ...
  extends PriorityQueue<Segment<K, V>> implements RawKeyValueIterator {
    ...
    private void adjustPriorityQueue(Segment<K, V> reader) throws IOException, MessageException{
