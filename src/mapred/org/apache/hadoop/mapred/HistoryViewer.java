...
class HistoryViewer {
  ...
  public void print() throws IOException, MessageException, ServiceException{
    printJobDetails();
    printTaskSummary();
    printJobAnalysis();
  ...
  private void printFailedAttempts(NodesFilter filter) throws IOException, MessageException, ServiceException {
