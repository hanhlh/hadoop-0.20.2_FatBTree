...
public class BloomMapFile {
  ...
  public static void delete(FileSystem fs, String name) throws IOException, MessageException {
  ...
  public static class Writer extends MapFile.Writer {
    ...
    public Writer(Configuration conf, FileSystem fs, String dirName,
        ...
        CompressionCodec codec, Progressable progress) throws IOException, MessageException, ServiceException {
    ...
    public Writer(Configuration conf, FileSystem fs, String dirName,
        WritableComparator comparator, Class valClass,
        CompressionType compress, Progressable progress) throws IOException, MessageException, ServiceException {
    ...
    public Writer(Configuration conf, FileSystem fs, String dirName,
        WritableComparator comparator, Class valClass) throws IOException, MessageException, ServiceException {
    ...
    public Writer(Configuration conf, FileSystem fs, String dirName,
        Class<? extends WritableComparable> keyClass,
        Class valClass) throws IOException, MessageException, ServiceException {
  ...
  public static class Reader extends MapFile.Reader {
    ...
    public Reader(FileSystem fs, String dirName, WritableComparator comparator,
        Configuration conf, boolean open) throws IOException, MessageException {
    ...
    private void initBloomFilter(FileSystem fs, String dirName,
        Configuration conf) throws MessageException {
      try {
