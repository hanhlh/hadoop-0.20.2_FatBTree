 ...
 * @throws MessageException
  ...
  public static Writer
    createWriter(FileSystem fs, Configuration conf, Path name,
                 Class keyClass, Class valClass,
                 CompressionType compressionType, CompressionCodec codec,
                 Progressable progress, Metadata metadata) throws IOException, MessageException, ServiceException {
    return createWriter(fs, conf, name, keyClass, valClass,
            fs.getConf().getInt("io.file.buffer.size", 4096),
            fs.getDefaultReplication(), fs.getDefaultBlockSize(),
 ...
 * @throws MessageException
  ...
  public static class Reader implements java.io.Closeable {
    ...
    private Reader(FileSystem fs, Path file, int bufferSize,
                   Configuration conf, boolean tempReader) throws IOException, MessageException {
    ...
    protected FSDataInputStream openFile(FileSystem fs, Path file,
        int bufferSize, long length) throws IOException, MessageException {
     ...
     * @throws MessageException */
    private synchronized void readBlock() throws IOException, MessageException {
     ...
     * @throws MessageException */
    public synchronized boolean next(Writable key) throws IOException, MessageException {
    ...
    public synchronized int next(DataOutputBuffer buffer) throws IOException, MessageException {
     ...
     * @throws MessageException */
    public synchronized Object next(Object key) throws IOException, MessageException {
     ...
     * @throws MessageException
     */
    public synchronized void seek(long position) throws IOException, MessageException {
      in.seek(position);
     ...
     * @throws MessageException */
    public synchronized void sync(long position) throws IOException, MessageException {
  ...
  public static class Sorter {
    ...
    public void sort(Path[] inFiles, Path outFile,
                     boolean deleteInput) throws IOException, MessageException, ServiceException {
     ...
     * @throws ServiceException
     */
    public void sort(Path inFile, Path outFile) throws IOException, MessageException, ServiceException {
      sort(new Path[]{inFile}, outFile, false);
    }

    private int sortPass(boolean deleteInput) throws IOException, MessageException, ServiceException {
    ...
    private class SortPass {
      ...
      public int run(boolean deleteInput) throws IOException, MessageException, ServiceException {
        int segments = 0;
        int currentFile = 0;
     ...
     * @throws MessageException
       */
      boolean next() throws IOException, MessageException;
      /** closes the iterator so that the underlying streams can be closed
       * @throws IOException
     * @throws MessageException
       */
      void close() throws IOException, MessageException;
     ...
     * @throws ServiceException
     */
    public void merge(Path[] inFiles, Path outFile) throws IOException, MessageException, ServiceException {
      if (fs.exists(outFile)) {
        throw new IOException("already exists: " + outFile);
      }
     ...
     * @throws ServiceException
     * @throws MessageException */
    private int mergePass(Path tmpDir) throws IOException, MessageException, ServiceException {
    ...
    private class MergeQueue extends PriorityQueue
      ...
      public void close() throws IOException, MessageException {
      ...
      public boolean next() throws IOException, MessageException {
        if (size() == 0)
          return false;
        if (minSegment != null) {
      ...
      private void adjustPriorityQueue(SegmentDescriptor ms) throws IOException, MessageException{
     ...
     * @throws MessageException
       */
      public RawKeyValueIterator merge() throws IOException, MessageException, ServiceException {
     ...
     * @throws MessageException
       */
      public boolean nextRawKey() throws IOException, MessageException {
        if (in == null) {
     ...
     * @throws MessageException
       */
      public void cleanup() throws IOException, MessageException {
        close();
        if (!preserveInput) {
     ...
     * @throws MessageException */
      public SegmentContainer(Path inName, Path indexIn) throws IOException, MessageException {
        //get the segments from indexIn
