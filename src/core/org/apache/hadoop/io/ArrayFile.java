...
public class ArrayFile extends MapFile {
  ...
  public static class Reader extends MapFile.Reader {
     ...
     * @throws MessageException */
    public Reader(FileSystem fs, String file, Configuration conf) throws IOException, MessageException {
      super(fs, file, conf);
    }

    /** Positions the reader before its <code>n</code>th value.
     * @throws MessageException */
    public synchronized void seek(long n) throws IOException, MessageException {
      key.set(n);
      seek(key);
    }
     ...
     * @throws MessageException */
    public synchronized Writable next(Writable value) throws IOException, MessageException {
