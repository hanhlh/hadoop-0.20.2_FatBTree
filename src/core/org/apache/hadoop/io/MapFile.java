...
public class MapFile {
  ...
  public static class Reader implements java.io.Closeable {
    ...
    protected synchronized void open(FileSystem fs, String dirName,
        WritableComparator comparator, Configuration conf) throws IOException, MessageException {
      Path dir = new Path(dirName);
      Path dataFile = new Path(dir, DATA_FILE_NAME);
      Path indexFile = new Path(dir, INDEX_FILE_NAME);
    ...
    protected SequenceFile.Reader createDataFileReader(FileSystem fs,
        Path dataFile, Configuration conf) throws IOException, MessageException {
      return new SequenceFile.Reader(fs, dataFile,  conf);
    }

    private void readIndex() throws IOException, MessageException {
     ...
     * @throws MessageException */
    public synchronized void reset() throws IOException, MessageException {
     ...
     * @throws MessageException
     */
    public synchronized WritableComparable midKey() throws IOException, MessageException {
     ...
     * @throws MessageException
     */
    public synchronized boolean seek(WritableComparable key) throws IOException, MessageException {
