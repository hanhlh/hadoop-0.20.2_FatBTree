...
public class Client {
  ...
  /** Th that reads responses and notifies callers.  Each connection owns a
  ...
  private class Connection extends Thread {
      ...
      try {
        ...
        while (true) {
          try {
        	...
        	//  handleConnectionFailure(timeoutFailures++, 2, toe);
    ...
    public void run() {
      ...
      /*System.out.println(getName() + ": starting, having connections "
              + connections.size());
*/
      ...
      /*System.out.println(getName() + ": stopped, remaining connections "
              + connections.size());*/
      if (LOG.isDebugEnabled())
    ...
    private void receiveResponse() {
      ...
      try {
    	//System.out.println("Client.receiveResponse() try to read an id");
        int id = in.readInt();                    // try to read an id

        //System.out.println("Client.receiveResponse() id "+id);
        if (LOG.isDebugEnabled())
    ...
    private synchronized void close() {
      ...
      if (closeException == null) {
        ...
        // cleanup calls
        cleanupCalls();
        System.out.println("Client.close() cleanup calls");
      }
      if (LOG.isDebugEnabled())
