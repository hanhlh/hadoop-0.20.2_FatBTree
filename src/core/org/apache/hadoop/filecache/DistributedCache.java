 ...
 * @throws MessageException
  ...
  private static void deleteCache(Configuration conf) throws IOException, MessageException {
 ...
 * @throws MessageException
   */
  public static void purgeCache(Configuration conf) throws IOException, MessageException {
    synchronized (cachedArchives) {
      FileSystem localFs = FileSystem.getLocal(conf);
