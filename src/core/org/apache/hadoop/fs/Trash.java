 ...
 * @throws MessageException
   */
  public Trash(Configuration conf) throws IOException, MessageException {
  ...
  private Trash(Path home, Configuration conf) throws IOException, MessageException {
    super(conf);
 ...
 * @throws ServiceException
   */
  public boolean moveToTrash(Path path) throws IOException, MessageException, ServiceException {
    if (interval == 0)
      return false;
 ...
 * @throws MessageException
 * @throws ServiceException */
  public void checkpoint() throws IOException, MessageException, ServiceException {
 ...
 * @throws MessageException */
  public void expunge() throws IOException, MessageException {
 ...
 * @throws MessageException
   */
  public Runnable getEmptier() throws IOException, MessageException {
  ...
  private static class Emptier implements Runnable {
    ...
    public Emptier(Configuration conf) throws IOException, MessageException {
      this.conf = conf;
      this.interval = conf.getLong("fs.trash.interval", 60) * MSECS_PER_MINUTE;
