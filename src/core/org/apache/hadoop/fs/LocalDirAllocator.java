 ...
 * @throws MessageException
   *  @throws IOException
   */
  public boolean ifExists(String pathStr,Configuration conf) throws MessageException {
    AllocatorPerContext context = obtainContext(contextCfgItemName);
  ...
  private static class AllocatorPerContext {
     ...
     * @throws MessageException
     */
    private void confChanged(Configuration conf) throws IOException, MessageException {
     ...
     * @throws MessageException
     */
    public synchronized boolean ifExists(String pathStr,Configuration conf) throws MessageException {
      try {
        int numDirs = localDirs.length;
        int numDirsSearched = 0;
        //remove the leading slash from the path (to make sure that the uri
