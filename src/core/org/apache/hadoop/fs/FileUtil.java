 ...
 * @throws MessageException */
  public static boolean copy(FileSystem srcFS, Path src,
                             ...
                             boolean overwrite,
                             Configuration conf) throws IOException, MessageException, ServiceException {
	  StringUtility.debugSpace("FileUtil.copy line 197");
 ...
 * @throws MessageException */
  public static boolean copyMerge(FileSystem srcFS, Path srcDir,
                                  ...
                                  boolean deleteSource,
                                  Configuration conf, String addString) throws IOException, MessageException, ServiceException {
 ...
 * @throws MessageException */
  ...
  private static Path checkDest(String srcName, FileSystem dstFS, Path dst,
      boolean overwrite) throws IOException, MessageException {
    if (dstFS.exists(dst)) {
    	FileStatus sdst = dstFS.getFileStatus(dst);
    	if (sdst.isDir()) {
    		if (null == srcName) {
