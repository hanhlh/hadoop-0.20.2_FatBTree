...
public class FsShell extends Configured implements Tool {
  ...
  protected void init() throws IOException, MessageException {
 ...
 * @throws MessageException
   */
  private void copyFromStdin(Path dst, FileSystem dstFs) throws IOException, MessageException, ServiceException {
 ...
 * @throws MessageException
   */
  void copyFromLocal(Path[] srcs, String dstf) throws IOException, MessageException, ServiceException {
 ...
 * @throws MessageException
   */
  void moveFromLocal(Path[] srcs, String dstf) throws IOException, MessageException, ServiceException {
    Path dstPath = new Path(dstf);
    FileSystem dstFs = dstPath.getFileSystem(getConf());
 ...
 * @throws MessageException
   */
  void moveFromLocal(Path src, String dstf) throws IOException, MessageException, ServiceException {
 ...
 * @throws ServiceException
   ...
   */
  void copyToLocal(String[]argv, int pos) throws IOException, MessageException, ServiceException {
 ...
 * @throws MessageException
  ...
  private void copyToLocal(final FileSystem srcFS, final Path src,
    ...
    //if (!srcFS.getFileStatus(src).isDir()) {
	  if (!srcFS.getFileStatus(src, false).isDir()) {
      if (dst.exists()) {
 ...
 * @throws MessageException
   ...
   * @see org.apache.hadoop.fs.FileSystem.globStatus
   */
  void copyMergeToLocal(String srcf, Path dst) throws IOException, MessageException, ServiceException {
 ...
 * @throws MessageException
   ...
   * @see org.apache.hadoop.fs.FileSystem.globStatus
   */
  void copyMergeToLocal(String srcf, Path dst, boolean endline) throws IOException, MessageException, ServiceException {
 ...
 * @throws ServiceException
   ...
   * @see org.apache.hadoop.fs.FileSystem.globStatus
   */
  void cat(String src, boolean verifyChecksum) throws IOException, MessageException, ServiceException {
    ...
    new DelayedExceptionThrowing() {
      @Override
      void process(Path p, FileSystem srcFs) throws IOException, MessageException {
        try {
  ...
  private class TextRecordInputStream extends InputStream {
    ...
    public TextRecordInputStream(FileStatus f) throws IOException, MessageException {
  ...
  private InputStream forMagic(Path p, FileSystem srcFs) throws IOException, MessageException {
  ...
  void text(String srcf) throws IOException, MessageException, ServiceException {
 ...
 * @throws MessageException
   */
  private void setReplication(String[] cmd, int pos) throws IOException, MessageException {
 ...
 * @throws MessageException
   */
  void waitForReplication(List<Path> waitList, int rep) throws IOException, MessageException {
    for(Path f : waitList) {
 ...
 * @throws MessageException
   * @see org.apache.hadoop.fs.FileSystem#globStatus(Path)
   */
  private int ls(String srcf, boolean recursive) throws IOException, MessageException {
    Path srcPath = new Path(srcf);
  ...
  private int ls(FileStatus src, FileSystem srcFs, boolean recursive,
      boolean printHeader) throws IOException, MessageException {
 ...
 * @throws MessageException
   * @see org.apache.hadoop.fs.FileSystem#globStatus(Path)
   */
  void du(String src) throws IOException, MessageException {
 ...
 * @throws MessageException
   * @see org.apache.hadoop.fs.FileSystem#globStatus(Path)
   */
  void dus(String src) throws IOException, MessageException {
    Path srcPath = new Path(src);
    FileSystem srcFs = srcPath.getFileSystem(getConf());
 ...
 * @throws MessageException
   */
  void mkdir(String src) throws IOException, MessageException {
	  StringUtility.debugSpace("FsShell.mkdir "+src);
    Path f = new Path(src);
    //f.setIsDirectory(true);
    FileSystem srcFs = f.getFileSystem(getConf());
    FileStatus fstatus = null;
    try {
      fstatus = srcFs.getFileStatus(f, false);
       if (fstatus.isDir()) {
        ...
        //if (!srcFs.mkdirs(f)) {
    	if (!srcFs.mkdirs(f, f.isDirectory())) {
          throw new IOException("failed to create " + src);
        }
    }
  }

  void synchronizeRootNodes () throws IOException, ServiceException, MessageException {
	  fs.synchronizeRootNodes();
  }
 ...
 * @throws MessageException
   */
  void touchz(String src) throws IOException, MessageException, ServiceException {
    Path f = new Path(src);
    FileSystem srcFs = f.getFileSystem(getConf());
    FileStatus st;
    if (srcFs.exists(f)) {
 ...
 * @throws MessageException
   */
  int test(String argv[], int i) throws IOException, MessageException {
 ...
 * @throws MessageException
   */
  void stat(char[] fmt, String src) throws IOException, MessageException {
    Path srcPath = new Path(src);
    FileSystem srcFs = srcPath.getFileSystem(getConf());
 ...
 * @throws ServiceException
   * @see org.apache.hadoop.fs.FileSystem#globStatus(Path)
   */
  void rename(String srcf, String dstf) throws IOException, MessageException, ServiceException {
    Path srcPath = new Path(srcf);
    Path dstPath = new Path(dstf);
    FileSystem srcFs = srcPath.getFileSystem(getConf());
    FileSystem dstFs = dstPath.getFileSystem(getConf());
 ...
 * @throws ServiceException
   * @exception: IOException
   */
  private int rename(String argv[], Configuration conf) throws IOException, MessageException, ServiceException {
    int i = 0;
    int exitCode = 0;
    String cmd = argv[i++];
 ...
 * @throws MessageException
   * @see org.apache.hadoop.fs.FileSystem#globStatus(Path)
   */
  void copy(String srcf, String dstf, Configuration conf) throws IOException, MessageException, ServiceException {
    Path srcPath = new Path(srcf);
    FileSystem srcFs = srcPath.getFileSystem(getConf());
    Path dstPath = new Path(dstf);
    FileSystem dstFs = dstPath.getFileSystem(getConf());
 ...
 * @throws MessageException
   * @exception: IOException
   */
  private int copy(String argv[], Configuration conf) throws IOException, MessageException, ServiceException {
    int i = 0;
    int exitCode = 0;
    String cmd = argv[i++];
    String dest = argv[argv.length-1];
 ...
 * @throws ServiceException
  ...
  void delete(String srcf, final boolean recursive, final boolean skipTrash)
    ...
    new DelayedExceptionThrowing() {
      @Override
      void process(Path p, FileSystem srcFs) throws IOException, ServiceException {
        try {
  ...
  private void delete(Path src, FileSystem srcFs, boolean recursive,
                      boolean skipTrash) throws IOException, MessageException, ServiceException {
    FileStatus fs = null;
    try {
  ...
  private void expunge() throws IOException, MessageException, ServiceException {
    trash.expunge();
    trash.checkpoint();
  }
 ...
 * @throws MessageException
   */
  private void tail(String[] cmd, int pos) throws IOException, MessageException {
  ...
  static abstract class CmdHandler {
    ...
    public abstract void run(FileStatus file, FileSystem fs) throws IOException, MessageException;
  }
 ...
 * @throws MessageException */
  private static FileStatus[] shellListStatus(String cmd,
                                                   FileSystem srcFs,
                                                   FileStatus src) throws MessageException {
    if (!src.isDir()) {
 ...
 * @throws MessageException
  ...
  private static int runCmdHandler(CmdHandler handler, FileStatus stat,
                                   FileSystem srcFs,
                                   boolean recursive) throws IOException, MessageException {
    int errors = 0;
  ...
  private void printHelp(String cmd) {
    ...
    String synchronizedInitialRootNodes = "Synchronize initial root nodes for FatBTree";
    ...
    } else if ("synchronizeInitialRootNodes".equals(cmd)) {
        System.out.println(synchronizedInitialRootNodes);
 ...
 * @throws MessageException
   */
  private int doall(String cmd, String argv[], int startindex) throws MessageException, ServiceException {
    int exitCode = 0;
    int i = startindex;
  ...
  private static void printUsage(String cmd) {
    ...
    if ("-fs".equals(cmd)) {
      ...
      else if ("-synchronizedInitialRootNodes".equals(cmd)) {
        System.err.println("Usage: java FsShell [-synchronizedInitialRootNodes]");
    }else {
      System.err.println("Usage: java FsShell");
      ...
      System.err.println("           [-synchronizedInitialRootNodes]");
  ...
  public int run(String argv[]) throws Exception {
    ...
    //
    if ("synchronizedInitialRootNodes".equals(cmd)) {
    	if (argv.length < 1) {
    		printUsage(cmd);
    		return exitCode;
    	}
  ...
  private abstract class DelayedExceptionThrowing {
    abstract void process(Path p, FileSystem srcFs) throws IOException, MessageException, ServiceException;
