 ...
 * @throws MessageException */
  public File pathToFile(Path path) throws MessageException {
    checkPath(path);
    if (!path.isAbsolute()) {
  ...
  class LocalFSFileInputStream extends FSInputStream {
    ...
    public LocalFSFileInputStream(Path f) throws IOException, MessageException {
  ...
  class LocalFSFileOutputStream extends OutputStream implements Syncable {
    ...
    private LocalFSFileOutputStream(Path f, boolean append) throws IOException, MessageException {
 ...
 * @throws MessageException */
  public FSDataOutputStream append(Path f, int bufferSize,
      Progressable progress) throws IOException, MessageException {
    if (!exists(f)) {
 ...
 * @throws MessageException */
  ...
  @Deprecated
  public boolean delete(Path p) throws IOException, MessageException {
    return delete(p, true);
  }

  public boolean delete(Path p, boolean recursive) throws IOException, MessageException {
    File f = pathToFile(p);
    if (f.isFile()) {
      return f.delete();
 ...
 * @throws MessageException */
  ...
  public void moveFromLocalFile(Path src, Path dst) throws IOException, MessageException, ServiceException {
    rename(src, dst);
  }
