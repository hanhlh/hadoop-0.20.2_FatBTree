 ...
 * @throws MessageException
  ...
  // of archives
  public int getHarVersion() throws IOException, MessageException {
 ...
 * @throws MessageException
  ...
  private String fileStatusInIndex(Path harPath) throws IOException, MessageException {
    // read the index file
  ...
  private static class HarFSDataInputStream extends FSDataInputStream {
    ...
    private static class HarFsInputStream extends FSInputStream {
      ...
      HarFsInputStream(FileSystem fs, Path path, long start,
          long length, int bufferSize) throws IOException, MessageException {
      ...
      public synchronized void seek(long pos) throws IOException, MessageException {
     ...
     * @throws MessageException
      ...
      public void readFully(long pos, byte[] b) throws IOException, MessageException {
    ...
    public HarFSDataInputStream(FileSystem fs, Path  p, long start,
        long length, int bufsize) throws IOException, MessageException {
