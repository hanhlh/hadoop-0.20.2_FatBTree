 ...
 * @throws MessageException
  ...
  public static void writePartitionFile(JobConf conf,
                                        Path partFile) throws IOException, MessageException, ServiceException {
  ...
  static class TeraRecordReader implements RecordReader<Text,Text> {
    ...
    public TeraRecordReader(Configuration job,
                            FileSplit split) throws IOException, MessageException {
  ...
  public RecordReader<Text, Text>
      getRecordReader(InputSplit split,
                      JobConf job,
                      Reporter reporter) throws IOException, MessageException {
    return new TeraRecordReader(job, (FileSplit) split);
  }

  @Override
  public InputSplit[] getSplits(JobConf conf, int splits) throws IOException, MessageException {
    if (conf == lastConf) {
      return lastResult;
    }
    lastConf = conf;
