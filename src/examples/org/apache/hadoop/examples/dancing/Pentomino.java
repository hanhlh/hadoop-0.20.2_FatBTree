 ...
 * @throws MessageException
   */
  public int solve(int[] split) throws MessageException, ServiceException {
 ...
 * @throws MessageException
   */
  public int solve() throws MessageException, ServiceException {
 ...
 * @throws MessageException
   */
  public static void main(String[] args) throws MessageException, ServiceException {
    int width = 6;
    int height = 10;
