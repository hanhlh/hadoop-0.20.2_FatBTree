...
public class DancingLinks<ColumnName> {
  ...
  public interface SolutionAcceptor<ColumnName> {
     ...
     */
    void solution(List<List<ColumnName>> value) throws MessageException, ServiceException;
  }
 ...
 * @throws MessageException
   */
  private int search(List<Node<ColumnName>> partial, SolutionAcceptor<ColumnName> output) throws MessageException, ServiceException {
    int results = 0;
    if (head.right == head) {
 ...
 * @throws MessageException
   */
  public int solve(int[] prefix, SolutionAcceptor<ColumnName> output) throws MessageException, ServiceException {
 ...
 * @throws MessageException
   */
  public int solve(SolutionAcceptor<ColumnName> output) throws MessageException, ServiceException {
