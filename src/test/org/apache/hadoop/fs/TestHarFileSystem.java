...
public class TestHarFileSystem extends TestCase {
  ...
  static class TextMapperReducer implements Mapper<LongWritable, Text, Text, Text>,
    ...
    public void map(LongWritable key, Text value, OutputCollector<Text, Text> output, Reporter reporter) throws IOException, MessageException, ServiceException {
    ...
    public void reduce(Text key, Iterator<Text> values, OutputCollector<Text, Text> output, Reporter reporter) throws IOException, MessageException, ServiceException {
