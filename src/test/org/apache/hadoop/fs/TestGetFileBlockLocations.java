...
public class TestGetFileBlockLocations extends TestCase {
  ...
  public void testFailureNegativeParameters() throws IOException, MessageException {
  ...
  public void testGetFileBlockLocations1() throws IOException, MessageException {
    FileStatus status = fs.getFileStatus(path);
  ...
  public void testGetFileBlockLocations2() throws IOException, MessageException {
    FileStatus status = fs.getFileStatus(path);
