...
public class TestLocalFileSystemPermission extends TestCase {
  ...
  private Path writeFile(FileSystem fs, String name) throws IOException, MessageException, ServiceException {
 ...
 * @throws ServiceException */
  public void testLocalFSsetPermission() throws IOException, MessageException, ServiceException {
    if (Path.WINDOWS) {
  ...
  FsPermission getPermission(LocalFileSystem fs, Path p) throws IOException, MessageException {
 ...
 * @throws MessageException
 * @throws ServiceException */
  public void testLocalFSsetOwner() throws IOException, MessageException, ServiceException {
    if (Path.WINDOWS) {
      System.out.println("Cannot run test for Windows");
      return;
    }
  ...
  String getGroup(LocalFileSystem fs, Path p) throws IOException, MessageException {
