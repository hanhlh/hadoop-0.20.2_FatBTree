...
public abstract class FileSystemContractBaseTest extends TestCase {
  ...
  private void writeReadAndDelete(int len) throws IOException, MessageException, ServiceException {
  ...
  public void testOverwrite() throws IOException, MessageException, ServiceException {
    Path path = path("/test/hadoop/file");
  ...
  public void testWriteInNonExistentDirectory() throws IOException, MessageException, ServiceException {
    Path path = path("/test/hadoop/file");
  ...
  public void testDeleteNonExistentFile() throws IOException, MessageException {
    Path path = path("/test/hadoop/file");
    assertFalse("Doesn't exist", fs.exists(path));
    assertFalse("No deletion", fs.delete(path, true));
  }

  public void testDeleteRecursively() throws IOException, MessageException, ServiceException {
  ...
  public void testDeleteEmptyDirectory() throws IOException, MessageException {
    Path dir = path("/test/hadoop");
  ...
  public void testInputStreamClosedTwice() throws IOException, MessageException, ServiceException {
  ...
  public void testOutputStreamClosedTwice() throws IOException, MessageException, ServiceException {
    //HADOOP-4760 according to Closeable#close() closing already-closed
    //streams should have no effect.
    Path src = path("/test/hadoop/file");
  ...
  protected void createFile(Path path) throws IOException, MessageException, ServiceException {
  ...
  private void rename(Path src, Path dst, boolean renameSucceeded,
      boolean srcExists, boolean dstExists) throws IOException, MessageException, ServiceException {
