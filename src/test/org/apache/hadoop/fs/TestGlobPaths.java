...
public class TestGlobPaths extends TestCase {
  ...
  public void testPathFilter() throws IOException, MessageException {
    try {
  ...
  public void testPathFilterWithFixedLastComponent() throws IOException, MessageException {
    try {
      String[] files = new String[] { USER_DIR + "/a", USER_DIR + "/a/b",
  ...
  private void pTestLiteral() throws IOException, MessageException {
    try {
  ...
  private void pTestEscape() throws IOException, MessageException {
    try {
  ...
  private void pTestAny() throws IOException, MessageException {
    try {
  ...
  private void pTestClosure() throws IOException, MessageException {
    pTestClosure1();
    pTestClosure2();
    pTestClosure3();
    pTestClosure4();
  ...
  private void pTestClosure1() throws IOException, MessageException {
    try {
  ...
  private void pTestClosure2() throws IOException, MessageException {
    try {
  ...
  private void pTestClosure3() throws IOException, MessageException {
    try {
  ...
  private void pTestClosure4() throws IOException, MessageException {
    try {
  ...
  private void pTestClosure5() throws IOException, MessageException {
    try {
      String [] files = new String[] {USER_DIR+"/dir1/file1",
                                      USER_DIR+"/file1"};
      Path[] matchedPath = prepareTesting(USER_DIR+"/*/file1", files);
  ...
  private void pTestSet() throws IOException, MessageException {
    try {
  ...
  private void pTestRange() throws IOException, MessageException {
    try {
  ...
  private void pTestSetExcl() throws IOException, MessageException {
    try {
      String [] files = new String[] {USER_DIR+"/a.d", USER_DIR+"/a.e",
  ...
  private void pTestCombination() throws IOException, MessageException {
    try {
  ...
  private void pTestRelativePath() throws IOException, MessageException {
    try {
  ...
  /* Test {xx,yy} */
  private void pTestCurlyBracket() throws IOException, MessageException {
    Path[] matchedPath;
    String [] files;
    try {
  ...
  private void pTestJavaRegexSpecialChars() throws IOException, MessageException {
    try {
  ...
  private void cleanupDFS() throws IOException, MessageException {
