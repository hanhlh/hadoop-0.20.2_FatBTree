 ...
 * @throws ServiceException
  ...
  private abstract static class IOStatMapper extends IOMapperBase {
    ...
    void collectStats(OutputCollector<UTF8, UTF8> output,
                      String name,
                      long execTime,
                      Object objSize) throws IOException, MessageException, ServiceException {
  ...
  private static void readTest(FileSystem fs) throws IOException, MessageException, ServiceException {
  ...
  private static void cleanup(FileSystem fs) throws IOException, MessageException {
