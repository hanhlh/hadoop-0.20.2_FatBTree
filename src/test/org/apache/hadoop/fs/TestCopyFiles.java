 ...
 * @throws MessageException
  ...
  static MyFile createFile(Path root, FileSystem fs) throws IOException, MessageException, ServiceException {
  ...
  private static boolean checkFiles(FileSystem fs, String topdir, MyFile[] files,
      boolean existingOnly) throws IOException, MessageException {
    Path root = new Path(topdir);
  ...
  private static void updateFiles(FileSystem fs, String topdir, MyFile[] files,
        int nupdate) throws IOException, MessageException, ServiceException {
  ...
  private static FileStatus[] getFileStatus(FileSystem fs,
      String topdir, MyFile[] files) throws IOException, MessageException {
    return getFileStatus(fs, topdir, files, false);
  }
  private static FileStatus[] getFileStatus(FileSystem fs,
      String topdir, MyFile[] files, boolean existingOnly) throws IOException, MessageException {
    Path root = new Path(topdir);
  ...
  private static boolean checkUpdate(FileSystem fs, FileStatus[] old,
      String topdir, MyFile[] upd, final int nupdate) throws IOException, MessageException {
    Path root = new Path(topdir);
 ...
 * @throws MessageException */
  private static void deldir(FileSystem fs, String topdir) throws IOException, MessageException {
  ...
  static void create(FileSystem fs, Path f) throws IOException, MessageException, ServiceException {
