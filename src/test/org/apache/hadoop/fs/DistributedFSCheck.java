...
public class DistributedFSCheck extends TestCase {
  ...
  private void createInputFile(String rootName) throws IOException, MessageException, ServiceException {
  ...
  public static class DistributedFSCheckMapper extends IOMapperBase {
    ...
    void collectStats(OutputCollector<UTF8, UTF8> output,
                      String name,
                      long execTime,
                      Object corruptedBlock) throws IOException, MessageException, ServiceException {
  ...
  private void cleanup() throws IOException, MessageException {
