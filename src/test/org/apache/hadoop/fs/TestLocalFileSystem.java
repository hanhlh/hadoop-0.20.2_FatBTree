...
public class TestLocalFileSystem extends TestCase {
  ...
  static void writeFile(FileSystem fs, Path name) throws IOException, MessageException, ServiceException {
    FSDataOutputStream stm = fs.create(name);
    stm.writeBytes("42\n");
    stm.close();
  }

  static String readFile(FileSystem fs, Path name) throws IOException, MessageException {
  ...
  private void cleanupFile(FileSystem fs, Path name) throws IOException, MessageException {
 ...
 * @throws ServiceException
   */
  public void testWorkingDirectory() throws IOException, MessageException, ServiceException {
  ...
  public void testCopy() throws IOException, MessageException, ServiceException {
    Configuration conf = new Configuration();
  ...
  public void testHomeDirectory() throws IOException, MessageException {
    Configuration conf = new Configuration();
    FileSystem fileSys = FileSystem.getLocal(conf);
  ...
  public void testPathEscapes() throws IOException, MessageException, ServiceException {
    Configuration conf = new Configuration();
