...
public class TestTrash extends TestCase {
  ...
  protected static Path writeFile(FileSystem fs, Path f) throws IOException, MessageException, ServiceException {
  ...
  protected static Path mkdir(FileSystem fs, Path p) throws IOException, MessageException {
  ...
  protected static void checkTrash(FileSystem fs, Path trashRoot,
      Path path) throws IOException, MessageException {
  ...
  public static void trashNonDefaultFS(Configuration conf) throws IOException, MessageException, ServiceException {
    conf.set("fs.trash.interval", "10"); // 10 minute
  ...
  public void testTrash() throws IOException, MessageException, ServiceException {
    Configuration conf = new Configuration();
    conf.setClass("fs.file.impl", TestLFS.class, FileSystem.class);
    trashShell(FileSystem.getLocal(conf), TEST_DIR);
  }

  public void testNonDefaultFS() throws IOException, MessageException, ServiceException {
    Configuration conf = new Configuration();
    conf.setClass("fs.file.impl", TestLFS.class, FileSystem.class);
