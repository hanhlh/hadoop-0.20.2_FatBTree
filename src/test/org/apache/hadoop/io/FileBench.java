...
"-D filebench.val.words=20\n");
  ...
  static long writeBench(JobConf conf) throws IOException, MessageException, ServiceException {
  ...
  static long readBench(JobConf conf) throws IOException, MessageException, ServiceException {
 ...
 * @throws ServiceException
   */
  public int run(String[] argv) throws IOException, MessageException, ServiceException {
  ...
  enum RW {
    w() {
      public long exec(String fn, JobConf job) throws IOException, MessageException, ServiceException {
    ...
    public abstract long exec(String fn, JobConf job) throws IOException, MessageException, ServiceException;
  }
