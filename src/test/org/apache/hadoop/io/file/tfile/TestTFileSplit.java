...
public class TestTFileSplit extends TestCase {
  ...
  void createFile(int count, String compress) throws IOException, MessageException, ServiceException {
  ...
  void readFile() throws IOException, MessageException {
   ...
   */
  void readRowSplits(int numSplits) throws IOException, MessageException {
  ...
  void checkRecNums() throws IOException, MessageException {
  ...
  public void testSplit() throws IOException, MessageException, ServiceException {
