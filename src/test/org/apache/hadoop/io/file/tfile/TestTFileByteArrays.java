...
public class TestTFileByteArrays extends TestCase {
  ...
  public void testNoDataEntry() throws IOException, MessageException {
    if (skip)
      return;
    closeOutput();
  ...
  public void testOneDataEntry() throws IOException, MessageException {
    if (skip)
      return;
    writeRecords(1);
    readRecords(1);
  ...
  public void testTwoDataEntries() throws IOException, MessageException {
    if (skip)
      return;
    writeRecords(2);
    readRecords(2);
 ...
 * @throws MessageException
   */
  public void testOneBlock() throws IOException, MessageException {
    if (skip)
      return;
 ...
 * @throws MessageException
   */
  public void testOneBlockPlusOneEntry() throws IOException, MessageException {
    if (skip)
      return;
  ...
  public void testTwoBlocks() throws IOException, MessageException {
    if (skip)
      return;
  ...
  public void testThreeBlocks() throws IOException, MessageException {
    if (skip)
      return;
  ...
  public void testLocate() throws IOException, MessageException {
    if (skip)
      return;
  ...
  public void testFailureWriterNotClosed() throws IOException, MessageException {
    if (skip)
      return;
    Reader reader = null;
    try {
  ...
  public void testFailureGetNonExistentMetaBlock() throws IOException, MessageException {
    if (skip)
      return;
    writer.append("keyX".getBytes(), "valueX".getBytes());
  ...
  public void testFailureReadValueManyTimes() throws IOException, MessageException {
    if (skip)
      return;
    writeRecords(5);
  ...
  public void testFailureBadCompressionCodec() throws IOException, MessageException, ServiceException {
    if (skip)
      return;
    closeOutput();
    out = fs.create(path);
  ...
  public void testFailureOpenEmptyFile() throws IOException, MessageException, ServiceException {
    if (skip)
      return;
    closeOutput();
  ...
  public void testFailureOpenRandomFile() throws IOException, MessageException, ServiceException {
    if (skip)
      return;
    closeOutput();
  ...
  public void testFailureNegativeOffset_2() throws IOException, MessageException {
    if (skip)
      return;
    closeOutput();
  ...
  public void testFailureNegativeLength_2() throws IOException, MessageException {
    if (skip)
      return;
    closeOutput();
  ...
  public void testFailureNegativeLength_3() throws IOException, MessageException {
    if (skip)
      return;
    writeRecords(3);
  ...
  public void testFailureFileWriteNotAt0Position() throws IOException, MessageException, ServiceException {
    if (skip)
      return;
    closeOutput();
    out = fs.create(path);
  ...
  private void readRecords(int count) throws IOException, MessageException {
    readRecords(fs, path, count, conf);
  }

  static void readRecords(FileSystem fs, Path path, int count,
      Configuration conf) throws IOException, MessageException {
    Reader reader =
        new Reader(fs.open(path), fs.getFileStatus(path).getLen(), conf);
    Scanner scanner = reader.createScanner();
  ...
  private void checkBlockIndex(int count, int recordIndex,
      int blockIndexExpected) throws IOException, MessageException {
    Reader reader = new Reader(fs.open(path), fs.getFileStatus(path).getLen(), conf);
    Scanner scanner = reader.createScanner();
  ...
  private void readKeyManyTimes(int count, int recordIndex) throws IOException, MessageException {
    Reader reader = new Reader(fs.open(path), fs.getFileStatus(path).getLen(), conf);
