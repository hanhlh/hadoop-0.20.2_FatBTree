...
public class TestVLong extends TestCase {
  ...
  public void testVLongByte() throws IOException, MessageException, ServiceException {
  ...
  private long writeAndVerify(int shift) throws IOException, MessageException, ServiceException {
    FSDataOutputStream out = fs.create(path);
  ...
  public void testVLongShort() throws IOException, MessageException, ServiceException {
  ...
  public void testVLong3Bytes() throws IOException, MessageException, ServiceException {
  ...
  public void testVLong4Bytes() throws IOException, MessageException, ServiceException {
  ...
  public void testVLong5Bytes() throws IOException, MessageException, ServiceException {
    long size = writeAndVerify(Byte.SIZE * 3);
     Assert.assertEquals("Incorrect encoded size", (1 << Short.SIZE) * 6 - 256
        - 16 - 3, size);
  }

  private void verifySixOrMoreBytes(int bytes) throws IOException, MessageException, ServiceException {
  ...
  public void testVLong6Bytes() throws IOException, MessageException, ServiceException {
    verifySixOrMoreBytes(6);
  }

  public void testVLong7Bytes() throws IOException, MessageException, ServiceException {
    verifySixOrMoreBytes(7);
  }

  public void testVLong8Bytes() throws IOException, MessageException, ServiceException {
    verifySixOrMoreBytes(8);
  }

  public void testVLongRandom() throws IOException, MessageException, ServiceException {
    int count = 1024 * 1024;
