...
public class TestTFileSeqFileComparison extends TestCase {
  ...
  static class SeqFileAppendable implements KVAppendable {
    ...
    public SeqFileAppendable(FileSystem fs, Path path, int osBufferSize,
        String compress, int minBlkSize) throws IOException, MessageException, ServiceException {
  ...
  private void reportStats(Path path, long totalBytes) throws IOException, MessageException {
  ...
  private void timeWrite(Path path, KVAppendable appendable, int baseKlen,
      int baseVlen, long fileSize) throws IOException, MessageException {
  ...
  private void timeRead(Path path, KVReadable readable) throws IOException, MessageException {
  ...
  private void readTFile(String parameters, boolean delFile) throws IOException, MessageException {
  ...
  private void compareRun(String compress) throws IOException, MessageException, ServiceException {
  ...
  public void testRunComparisons() throws IOException, MessageException, ServiceException {
