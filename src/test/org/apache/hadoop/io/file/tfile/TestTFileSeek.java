...
public class TestTFileSeek extends TestCase {
  ...
  private void createTFile() throws IOException, MessageException, ServiceException {
    long totalBytes = 0;
  ...
  public void seekTFile() throws IOException, MessageException {
    int miss = 0;
    long totalBytes = 0;
  ...
  public void testSeeks() throws IOException, MessageException, ServiceException {
  ...
  public static void main(String[] argv) throws IOException, MessageException, ServiceException {
