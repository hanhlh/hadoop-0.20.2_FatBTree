...
public class TestTFile extends TestCase {
  ...
  private FSDataOutputStream createFSOutput(Path name) throws IOException, MessageException, ServiceException {
 ...
 * @throws
   */
  void basicWithSomeCodec(String codec) throws IOException,  MessageException, ServiceException{
  ...
  void unsortedWithSomeCodec(String codec) throws IOException, MessageException, ServiceException {
  ...
  public void testTFileFeatures() throws IOException, MessageException, ServiceException {
    basicWithSomeCodec("none");
    basicWithSomeCodec("gz");
  }

  // test unsorted t files.
  public void testUnsortedTFileFeatures() throws IOException, MessageException, ServiceException {
  ...
  public void testMetaBlocks() throws IOException, MessageException, ServiceException {
