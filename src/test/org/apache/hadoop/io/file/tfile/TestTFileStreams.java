...
public class TestTFileStreams extends TestCase {
  ...
  public void testNoEntry() throws IOException, MessageException {
    if (skip)
      return;
    closeOutput();
  ...
  public void testOneEntryKnownLength() throws IOException, MessageException {
    if (skip)
      return;
  ...
  public void testOneEntryUnknownLength() throws IOException, MessageException {
    if (skip)
      return;
  ...
  public void testOneEntryMixedLengths1() throws IOException, MessageException {
    if (skip)
      return;
  ...
  public void testOneEntryMixedLengths2() throws IOException, MessageException {
    if (skip)
      return;
  ...
  public void testTwoEntriesKnownLength() throws IOException, MessageException {
    if (skip)
      return;
  ...
  public void testFailureNegativeOffset() throws IOException, MessageException {
    if (skip)
      return;
    writeRecords(2, true, true);
