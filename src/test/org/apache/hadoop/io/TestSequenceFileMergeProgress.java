...
public class TestSequenceFileMergeProgress extends TestCase {
  ...
  public void testMergeProgressWithNoCompression() throws IOException, MessageException, ServiceException {
    runTest(SequenceFile.CompressionType.NONE);
  }

  public void testMergeProgressWithRecordCompression() throws IOException, MessageException, ServiceException {
    runTest(SequenceFile.CompressionType.RECORD);
  }

  public void testMergeProgressWithBlockCompression() throws IOException, MessageException, ServiceException {
    runTest(SequenceFile.CompressionType.BLOCK);
  }

  public void runTest(CompressionType compressionType) throws IOException, MessageException, ServiceException {
