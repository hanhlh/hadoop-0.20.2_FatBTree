...
public class TestMapReduceLocal extends TestCase {
  ...
  public static Path writeFile(String name, String data) throws IOException, MessageException, ServiceException {
  ...
  public static String readFile(String name) throws IOException, MessageException {
