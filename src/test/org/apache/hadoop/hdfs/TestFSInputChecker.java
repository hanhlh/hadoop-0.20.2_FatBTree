...
public class TestFSInputChecker extends TestCase {
  ...
  private void testFileCorruption(LocalFileSystem fileSys) throws IOException, MessageException, ServiceException {
  ...
  private void checkFileCorruption(LocalFileSystem fileSys, Path file,
                                   Path fileToCorrupt) throws IOException, MessageException {
  ...
  private void checkSeekAndRead() throws IOException, MessageException {
    int position = 1;
