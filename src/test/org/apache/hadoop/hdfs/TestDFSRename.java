...
public class TestDFSRename extends junit.framework.TestCase {
  ...
  void list(FileSystem fs, String name) throws IOException, MessageException {
    FileSystem.LOG.info("\n\n" + name);
  ...
  static void createFile(FileSystem fs, Path f) throws IOException, MessageException, ServiceException {
