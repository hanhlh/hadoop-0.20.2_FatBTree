...
public class TestSeekBug extends TestCase {
  ...
  private void seekReadFile(FileSystem fileSys, Path name) throws IOException, MessageException {
   ...
   */
  private void smallReadSeek(FileSystem fileSys, Path name) throws IOException, MessageException {
 ...
 * @throws ServiceException
   */
  public void testSeekBugLocalFS() throws IOException, MessageException, ServiceException {
    Configuration conf = new Configuration();
