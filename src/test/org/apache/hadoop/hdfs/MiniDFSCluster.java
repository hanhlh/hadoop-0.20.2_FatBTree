 ...
 * @throws Exception
  ...
  public MiniDFSCluster(Configuration conf,
                        int numDataNodes,
                        StartupOption nameNodeOperation) throws Exception {
 ...
 * @throws Exception
  ...
  public MiniDFSCluster(int nameNodePort,
                        ...
                        StartupOption operation,
                        String[] racks,
                        long[] simulatedCapacities) throws Exception {
    this(nameNodePort, conf, numDataNodes, format, manageDfsDirs, manageDfsDirs,
 ...
 * @throws MessageException
   */
  public FileSystem getFileSystem() throws IOException, MessageException {
