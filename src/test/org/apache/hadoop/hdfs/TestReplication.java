 ...
 * @throws Exception
   */
  public void runReplication(boolean simulated) throws Exception {
    Configuration conf = new Configuration();
  ...
  public void testReplicationSimulatedStorag() throws Exception {
    runReplication(true);
  }
   ...
   */
  public void testPendingReplicationRetry() throws Exception {
  ...
  private void changeBlockLen(MiniDFSCluster cluster,
      int lenDelta) throws IOException, InterruptedException, MessageException, ServiceException {
