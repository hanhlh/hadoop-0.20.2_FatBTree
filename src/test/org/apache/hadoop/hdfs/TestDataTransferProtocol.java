...
public class TestDataTransferProtocol extends TestCase {
  ...
  void createFile(FileSystem fs, Path path, int fileLen) throws IOException, MessageException, ServiceException {
  ...
  void readFile(FileSystem fs, Path path, int fileLen) throws IOException, MessageException {
    byte [] arr = new byte[fileLen];
    FSDataInputStream in = fs.open(path);
    in.readFully(arr);
  }

  public void testDataTransferProtocol() throws Exception {
