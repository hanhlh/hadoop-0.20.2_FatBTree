...
public class TestDFSShell extends TestCase {
  ...
  static Path writeFile(FileSystem fs, Path f) throws IOException, MessageException, ServiceException {
  ...
  static Path mkdir(FileSystem fs, Path p) throws IOException, MessageException {
  ...
  public void testRecrusiveRm() throws Exception {
	  Configuration conf = new Configuration();
	  MiniDFSCluster cluster = new MiniDFSCluster(conf, 2, true, null);
	  FileSystem fs = cluster.getFileSystem();
	  assertTrue("Not a HDFS: " + fs.getUri(),
  ...
  static String createTree(FileSystem fs, String name) throws IOException, MessageException, ServiceException {
    // create a tree
    //   ROOT
    //   |- f1
    //   |- f2
 ...
 * @throws ServiceException
  ...
  private void confirmOwner(String owner, String group,
                            FileSystem fs, Path... paths) throws IOException, MessageException {
    for(Path path : paths) {
      if (owner != null) {
