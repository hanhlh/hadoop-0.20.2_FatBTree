...
public class NNThroughputBenchmark {
  ...
  abstract class OperationStatsBase {
     ...
     */
    abstract void generateInputs(int[] opsPerThread) throws IOException, MessageException, ServiceException;
     ...
     * @throws MessageException
     */
    abstract long executeOp(int daemonId, int inputIdx, String arg1) throws IOException, MessageException, ServiceException;
    ...
    void benchmark() throws IOException, MessageException, ServiceException {
  ...
  private class StatsDaemon extends Thread {
    ...
    void benchmarkOne() throws IOException, MessageException, ServiceException {
  ...
  class CreateFileStats extends OperationStatsBase {
    ...
    void generateInputs(int[] opsPerThread) throws IOException, MessageException, ServiceException {
  ...
  class BlockReportStats extends OperationStatsBase {
    ...
    void generateInputs(int[] ignore) throws IOException, MessageException, ServiceException {
    ...
    private void addBlocks(String fileName, String clientName) throws IOException, MessageException {
