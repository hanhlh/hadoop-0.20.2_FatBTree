...
****/
  ...
  private void checkFile(FileSystem fs, Path name, int len) throws IOException, MessageException {
  ...
  private void checkFullFile(FileSystem fs, Path name) throws IOException, MessageException {
 ...
 * @throws Exception
   */
  public void testComplexAppend() throws Exception {
    initBuffer(fileSize);
    Configuration conf = new Configuration();
