 ...
 * @throws Exception
   */
  private void complexTest() throws Exception {
 ...
 * @throws Exception
   */
  private void simpleTest(int datanodeToKill) throws Exception {
    Configuration conf = new Configuration();
    conf.setInt("heartbeat.recheck.interval", 2000);
  ...
  public void testSimple0() throws Exception {simpleTest(0);}

  public void testSimple1() throws Exception {simpleTest(1);}

  public void testSimple2() throws Exception {simpleTest(2);}

  public void testComplex() throws Exception {complexTest();}
}
