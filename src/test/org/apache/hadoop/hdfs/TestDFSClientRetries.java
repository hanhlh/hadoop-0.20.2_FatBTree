 ...
 * @throws Exception
   */
  public void testWriteTimeoutAtDataNode() throws Exception {
  ...
  class TestNameNode implements ClientProtocol
  {
    ...
    public boolean create(String src, FsPermission masked, String clientName, boolean overwrite, short replication, long blockSize) throws IOException {return false;}
	...
	@Override
	public boolean transferNamespace(String targetMachine) throws IOException {
  ...
  public void testNotYetReplicatedErrors() throws IOException, MessageException, ServiceException
  {
    Configuration conf = new Configuration();
  ...
  private static class FailNTimesAnswer implements Answer<LocatedBlocks> {
    ...
    public LocatedBlocks answer(InvocationOnMock invocation) throws IOException {
      ...
      LocatedBlocks realAnswer = null;
	try {
		realAnswer = realNN.getBlockLocations(
		    (String)args[0],
		    (Long)args[1],
		    (Long)args[2]);
