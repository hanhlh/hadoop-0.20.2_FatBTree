...
public class TestPread extends TestCase {
  ...
  private void writeFile(FileSystem fileSys, Path name) throws IOException, MessageException, ServiceException {
  ...
  private void doPread(FSDataInputStream stm, long position, byte[] buffer,
                       int offset, int length) throws IOException, MessageException {
    int nread = 0;
    while (nread < length) {
  ...
  private void pReadFile(FileSystem fileSys, Path name) throws IOException, MessageException {
  ...
  private void cleanupFile(FileSystem fileSys, Path name) throws IOException, MessageException {
 ...
 * @throws Exception
   */
  public void testPreadDFS() throws Exception {
    dfsPreadTest(false); //normal pread
    dfsPreadTest(true); //trigger read code path without transferTo.
  }

  private void dfsPreadTest(boolean disableTransferTo) throws Exception {
  ...
  public void testPreadDFSSimulated() throws Exception {
 ...
 * @throws ServiceException
   */
  public void testPreadLocalFS() throws IOException, MessageException, ServiceException {
    Configuration conf = new Configuration();
