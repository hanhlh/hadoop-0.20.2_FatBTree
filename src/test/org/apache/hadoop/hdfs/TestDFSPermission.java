...
public class TestDFSPermission extends TestCase {
  ...
  private short getPermission(Path path) throws IOException, MessageException {
    return fs.getFileStatus(path).getPermission().toShort();
  }

  /* create a file/directory with the default umask and permission */
  private void create(OpType op, Path name) throws IOException, MessageException, ServiceException {
  ...
  private void create(OpType op, Path name, short umask,
      FsPermission permission) throws IOException, MessageException, ServiceException {
  ...
  private void checkPermission(Path name, short expectedPermission,
      boolean delete) throws IOException, MessageException {
    try {
  ...
  private void setOwner(Path path, String owner, String group,
      boolean expectDeny) throws IOException, MessageException {
    try {
  ...
  private String getGroup(Path path) throws IOException, MessageException {
    return fs.getFileStatus(path).getGroup();
  }

  /* Return the file owner of the file/directory */
  private String getOwner(Path path) throws IOException, MessageException {
  ...
  private void checkOwnership(Path name, String expectedOwner,
      String expectedGroup) throws IOException, MessageException {
  ...
  abstract class PermissionVerifier {
    ...
    abstract void call() throws IOException, MessageException, ServiceException;
  }
  ...
  private class CreatePermissionVerifier extends PermissionVerifier {
    ...
    @Override
    void call() throws IOException, MessageException, ServiceException {
      create(opType, path);
      if (cleanup) {
        fs.delete(path, true);
      }
  ...
  private class OpenPermissionVerifier extends PermissionVerifier {
    ...
    @Override
    void call() throws IOException, MessageException {
  ...
  private void login(UnixUserGroupInformation ugi) throws IOException, MessageException {
    if (fs != null) {
      fs.close();
    }
  ...
  /* test non-existent file */
  private void checkNonExistentFile() throws MessageException, ServiceException {
    try {
