...
public class DFSTestUtil extends TestCase {
  ...
  public void createFiles(FileSystem fs, String topdir) throws IOException, MessageException, ServiceException {
 ...
 * @throws ServiceException
  ...
  void createFiles(FileSystem fs, String topdir,
                   short replicationFactor) throws IOException, MessageException, ServiceException {
  ...
  public static void createFile(FileSystem fs, Path fileName, long fileLen,
      short replFactor, long seed) throws IOException, MessageException, ServiceException {
 ...
 * @throws MessageException */
  public boolean checkFiles(FileSystem fs, String topdir) throws IOException, MessageException {
 ...
 * @throws MessageException */
  public static void waitReplication(FileSystem fs, Path fileName,
      short replFactor)  throws IOException, MessageException {
    boolean good;
    do {
      good = true;
 ...
 * @throws MessageException */
  public void cleanup(FileSystem fs, String topdir) throws IOException, MessageException {
    Path root = new Path(topdir);
    fs.delete(root, true);
    files = null;
  }

  public static Block getFirstBlock(FileSystem fs, Path path) throws IOException, MessageException {
