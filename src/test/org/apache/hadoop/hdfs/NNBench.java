 ...
 * @throws MessageException
   */
  private static void cleanupBeforeTestrun() throws IOException, MessageException {
 ...
 * @throws MessageException
   */
  private static void createControlFiles() throws IOException, MessageException {
    FileSystem tempFS = FileSystem.get(config);
 ...
 * @throws MessageException
   */
  private static void analyzeResults() throws IOException, MessageException {
 ...
 * @throws ServiceException
   */
  public static void runTests() throws IOException, MessageException, ServiceException {
  ...
  static class NNBenchMapper extends Configured
    ...
    */
    ...
    private void doCreateWriteOp(String name,
            OutputCollector<Text, Text> output,
            Reporter reporter) throws MessageException, ServiceException {
    ...
    private void doOpenReadOp(String name,
            OutputCollector<Text, Text> output,
            Reporter reporter) throws MessageException {
