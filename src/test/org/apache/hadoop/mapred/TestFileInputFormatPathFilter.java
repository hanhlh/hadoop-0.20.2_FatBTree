...
public class TestFileInputFormatPathFilter extends TestCase {
  ...
  protected Path createFile(String fileName) throws IOException, MessageException, ServiceException {
  ...
  protected Set<Path> createFiles() throws IOException, MessageException, ServiceException {
