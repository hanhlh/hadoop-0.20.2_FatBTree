...
public class TestQueueManager extends TestCase {
  ...
  public void testAllEnabledACLForJobSubmission() throws Exception {
    JobConf conf = setupConf("mapred.queue.default.acl-submit-job", "*");
    verifyJobSubmission(conf, true);
  }

  public void testAllDisabledACLForJobSubmission() throws Exception {
    JobConf conf = setupConf("mapred.queue.default.acl-submit-job", "");
    verifyJobSubmission(conf, false);
  }

  public void testUserDisabledACLForJobSubmission() throws Exception {
    JobConf conf = setupConf("mapred.queue.default.acl-submit-job",
                                "3698-non-existent-user");
    verifyJobSubmission(conf, false);
  }

  public void testDisabledACLForNonDefaultQueue() throws Exception {
  ...
  public void testSubmissionToInvalidQueue() throws Exception{
    JobConf conf = new JobConf();
  ...
  public void testEnabledACLForNonDefaultQueue() throws Exception {
    // login as self...
  ...
  public void testAllEnabledACLForJobKill() throws Exception {
    JobConf conf = setupConf("mapred.queue.default.acl-administer-jobs", "*");
    verifyJobKill(conf, true);
  }

  public void testAllDisabledACLForJobKill() throws Exception {
    JobConf conf = setupConf("mapred.queue.default.acl-administer-jobs", "");
    verifyJobKillAsOtherUser(conf, false, "dummy-user,dummy-user-group");
  }

  public void testOwnerAllowedForJobKill() throws Exception {
    JobConf conf = setupConf("mapred.queue.default.acl-administer-jobs",
                                              "junk-user");
    verifyJobKill(conf, true);
  }

  public void testUserDisabledACLForJobKill() throws Exception {
  ...
  public void testUserEnabledACLForJobKill() throws Exception {
    // login as self...
    UserGroupInformation ugi = UnixUserGroupInformation.login();
    String userName = ugi.getUserName();
    JobConf conf = setupConf("mapred.queue.default.acl-administer-jobs",
  ...
  public void testUserDisabledForJobPriorityChange() throws Exception {
    JobConf conf = setupConf("mapred.queue.default.acl-administer-jobs",
                              "junk-user");
