...
public class TestMultiFileInputFormat extends TestCase{
  ...
  private Path initFiles(FileSystem fs, int numFiles, int numBytes) throws IOException, MessageException, ServiceException{
  ...
  public void testFormat() throws IOException, MessageException, ServiceException {
