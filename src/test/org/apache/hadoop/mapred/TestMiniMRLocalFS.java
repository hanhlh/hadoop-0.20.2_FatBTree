...
public class TestMiniMRLocalFS extends TestCase {
  ...
  private void runCustomFormats(MiniMRCluster mr) throws IOException, MessageException, ServiceException {
    JobConf job = mr.createJobConf();
  ...
  static class MyOutputFormat implements OutputFormat {
    static class MyRecordWriter implements RecordWriter<Object, Object> {
      ...
      public MyRecordWriter(Path outputFile, JobConf job) throws IOException, MessageException, ServiceException {
