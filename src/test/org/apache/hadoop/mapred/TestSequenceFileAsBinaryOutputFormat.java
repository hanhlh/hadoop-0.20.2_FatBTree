...
public class TestSequenceFileAsBinaryOutputFormat extends TestCase {
  ...
  public void testBinary() throws IOException, MessageException, ServiceException {
  ...
  public void testcheckOutputSpecsForbidRecordCompression() throws IOException, MessageException {
    JobConf job = new JobConf();
    FileSystem fs = FileSystem.getLocal(job);
