...
public class TestMultipleTextOutputFormat extends TestCase {
  ...
  private static void writeData(RecordWriter<Text, Text> rw) throws IOException, MessageException, ServiceException {
    for (int i = 10; i < 40; i++) {
      String k = "" + i;
      String v = "" + i;
  ...
  private static void test1(JobConf job) throws IOException, MessageException, ServiceException {
  ...
  private static void test2(JobConf job) throws IOException, MessageException, ServiceException {
    FileSystem fs = FileSystem.getLocal(job);
    String name = "part-00000";
