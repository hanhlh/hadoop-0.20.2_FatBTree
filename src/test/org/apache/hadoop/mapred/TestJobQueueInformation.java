...
public class TestJobQueueInformation extends TestCase {
  ...
  private JobConf configureWaitingJob(JobConf conf) throws IOException, MessageException {
  ...
  public void testJobQueues() throws IOException, MessageException, ServiceException {
