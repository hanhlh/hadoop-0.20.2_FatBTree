...
public class MRBench {
  ...
  public static class Reduce extends MapReduceBase
    ...
    public void reduce(UTF8 key, Iterator<UTF8> values,
                       OutputCollector<UTF8, UTF8> output, Reporter reporter) throws IOException, MessageException, ServiceException
    {
 ...
 * @throws MessageException
  ...
  public static void generateTextFile(FileSystem fs, Path inputFile,
                                      long numLines, Order sortOrder) throws IOException, MessageException, ServiceException
  {
 ...
 * @throws MessageException
   */
  private static JobConf setupJob(int numMaps, int numReduces, String jarFile) throws MessageException {
 ...
 * @throws MessageException
   */
  private static ArrayList<Long> runJobInSequence(JobConf masterJobConf, int numRuns) throws IOException, MessageException, ServiceException {
