 ...
 * @throws MessageException
   */
  static void cleanData(FileSystem fs, Path dirPath) throws IOException, MessageException {
 ...
 * @throws MessageException
   */
  static void generateData(FileSystem fs, Path dirPath) throws IOException, MessageException, ServiceException {
