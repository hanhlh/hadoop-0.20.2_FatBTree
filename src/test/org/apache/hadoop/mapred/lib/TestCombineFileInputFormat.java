...
public class TestCombineFileInputFormat extends TestCase{
  ...
  static void writeFile(Configuration conf, Path name,
      short replication, int numBlocks) throws IOException, MessageException, ServiceException {
   ...
   */
  private void splitRealFiles(String[] args) throws IOException, MessageException {
    JobConf conf = new JobConf();
