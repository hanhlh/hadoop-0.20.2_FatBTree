...
public class TestMapRed extends TestCase {
  ...
  static class RandomCheckMapper
    ...
    public void map(WritableComparable key, Text val,
                    OutputCollector<IntWritable, IntWritable> out,
                    Reporter reporter) throws IOException, NumberFormatException, MessageException, ServiceException {
  ...
  **/
  ...
  private static void printTextFile(FileSystem fs, Path p) throws IOException, MessageException {
  ...
  private static boolean isSequenceFile(FileSystem fs,
                                        Path f) throws IOException, MessageException {
