 ...
 * @throws ServiceException
  ...
  static void validateJobHistoryFileFormat(JobID id, JobConf conf,
                 String status, boolean splitsCanBeEmpty) throws IOException, MessageException, ServiceException  {
 ...
 * @throws ServiceException
  ...
  static void validateJobHistoryFileContent(MiniMRCluster mr,
                              RunningJob job, JobConf conf) throws IOException, MessageException, ServiceException  {
 ...
 * @throws ServiceException
   */
  public void testJobHistoryFile() throws IOException, MessageException, ServiceException {
  ...
  private static Path getLogLocationInOutputPath(String logFileName,
                                                      JobConf conf) throws MessageException {
 ...
 * @throws MessageException
  ...
  public void testJobHistoryUserLogLocation() throws IOException, MessageException, ServiceException {
    MiniMRCluster mr = null;
    try {
 ...
 * @throws ServiceException
  ...
  private static void validateJobHistoryJobStatus(JobID id, JobConf conf,
          String status) throws IOException, MessageException, ServiceException  {
  ...
  public void testJobHistoryJobStatus() throws IOException, MessageException, ServiceException {
    MiniMRCluster mr = null;
    try {
      mr = new MiniMRCluster(2, "file:///", 3);
