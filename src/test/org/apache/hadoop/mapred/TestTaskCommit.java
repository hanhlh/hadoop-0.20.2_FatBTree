...
public class TestTaskCommit extends HadoopTestCase {
  ...
  static class CommitterWithCommitFail extends FileOutputCommitter {
    public void commitTask(TaskAttemptContext context) throws IOException, MessageException {
  ...
  public void testCommitFail() throws IOException, MessageException, ServiceException {
    Path rootDir =
