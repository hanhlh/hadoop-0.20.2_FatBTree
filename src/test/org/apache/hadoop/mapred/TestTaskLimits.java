...
public class TestTaskLimits extends TestCase {
  ...
  static void runPI(MiniMRCluster mr, JobConf jobconf) throws IOException, MessageException, ServiceException {
    LOG.info("runPI");
 ...
 * @throws Exception
   */
  private boolean runOneTest(int maxTasks) throws Exception {
