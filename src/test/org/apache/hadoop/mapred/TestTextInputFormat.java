...
public class TestTextInputFormat extends TestCase {
  ...
  private static void writeFile(FileSystem fs, Path name,
                                ...
                                String contents) throws IOException, MessageException, ServiceException {
    OutputStream stm;
    if (codec == null) {
      stm = fs.create(name);
    } else {
  ...
  private static List<Text> readSplit(TextInputFormat format,
                                      InputSplit split,
                                      JobConf job) throws IOException, MessageException, ServiceException {
 ...
 * @throws ServiceException
   */
  public static void testGzip() throws IOException, MessageException, ServiceException {
    JobConf job = new JobConf();
 ...
 * @throws ServiceException
   */
  public static void testGzipEmpty() throws IOException, MessageException, ServiceException {
    JobConf job = new JobConf();
    CompressionCodec gzip = new GzipCodec();
    ReflectionUtils.setConf(gzip, job);
    localFs.delete(workDir, true);
