 ...
 * @throws MessageException
   */
  public void waitUntilIdle() throws MessageException {
    waitTaskTrackers();
 ...
 * @throws MessageException
  ...
  public MiniMRCluster(int numTaskTrackers, String namenode, int numDir,
      String[] racks, String[] hosts) throws IOException, MessageException {
 ...
 * @throws MessageException
  ...
  public MiniMRCluster(int jobTrackerPort,
      ...
      String namenode,
      int numDir,
      String[] racks) throws IOException, MessageException {
    this(jobTrackerPort, taskTrackerPort, numTaskTrackers, namenode,
         numDir, racks, null);
  }
 ...
 * @throws ServiceException
   */
  public void initializeJob(JobID jobId) throws IOException, MessageException, ServiceException {
