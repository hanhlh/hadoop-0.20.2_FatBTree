...
public class UtilsForTests {
  ...
  static String slurpHadoop(Path p, FileSystem fs) throws IOException, MessageException {
 ...
 * @throws MessageException
  ...
  implements Mapper<WritableComparable, Writable,
    ...
    public void configure(JobConf conf) throws MessageException {
      try {
 ...
 * @throws MessageException
  ...
  static void writeFile(NameNode namenode, Configuration conf, Path name,
      short replication) throws IOException, MessageException, ServiceException {
  ...
  static RunningJob runJob(JobConf conf, Path inDir, Path outDir, int numMaps,
                           int numReds) throws IOException, MessageException, ServiceException {
