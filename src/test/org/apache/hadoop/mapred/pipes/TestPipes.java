...
public class TestPipes extends TestCase {
  ...
  static void cleanup(FileSystem fs, Path p) throws IOException, MessageException {
    fs.delete(p, true);
  ...
  private void writeInputFile(FileSystem fs, Path dir) throws IOException, MessageException, ServiceException {
 ...
 * @throws ServiceException
  ...
  private void runNonPipedProgram(MiniMRCluster mr, MiniDFSCluster dfs,
                                  Path program) throws IOException, MessageException, ServiceException {
    JobConf job = mr.createJobConf();
