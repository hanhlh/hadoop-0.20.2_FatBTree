...
public class TestPermission extends TestCase {
  ...
  static FsPermission checkPermission(FileSystem fs,
      String path, FsPermission expected) throws IOException, MessageException {
  ...
  static boolean canMkdirs(FileSystem fs, Path p) throws IOException, MessageException {
    try {
      fs.mkdirs(p);
      return true;
  ...
  static boolean canCreate(FileSystem fs, Path p) throws IOException, MessageException, ServiceException {
    try {
      fs.create(p);
      return true;
    } catch(AccessControlException e) {
  ...
  static boolean canOpen(FileSystem fs, Path p) throws IOException, MessageException {
    try {
      fs.open(p);
      return true;
    } catch(AccessControlException e) {
