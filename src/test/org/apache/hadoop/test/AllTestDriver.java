...
import org.apache.hadoop.hdfs.CopyOfNNBenchWithoutMR;
import org.apache.hadoop.hdfs.DataReallocationUpGear;
import org.apache.hadoop.hdfs.NNBench;
import org.apache.hadoop.hdfs.NNBenchWithoutMR;
import org.apache.hadoop.hdfs.TestRangeSearch;
...
public class AllTestDriver {
  ...
  public static void main(String argv[]){
    ...
    try {
      ...
      pgd.addClass("CopyOfNNBenchWithoutMR", CopyOfNNBenchWithoutMR.class, "A benchmark that stresses the namenode.");
      pgd.addClass("DataReallocationUpGear", DataReallocationUpGear.class, "A benchmark that reallocates data when up gear.");
      pgd.addClass("RangeSearch", TestRangeSearch.class, "A benchmark for range search testing");
