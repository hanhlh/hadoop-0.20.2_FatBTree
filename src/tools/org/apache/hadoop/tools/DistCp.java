...
public class DistCp implements Tool {
  ...
  static class CopyInputFormat implements InputFormat<Text, Text> {
    ...
    public RecordReader<Text, Text> getRecordReader(InputSplit split,
        JobConf job, Reporter reporter) throws IOException, MessageException {
  ...
  static class CopyFilesMapper
    ...
    private boolean needsUpdate(FileStatus srcstatus,
        FileSystem dstfs, Path dstpath) throws IOException, MessageException {
    ...
    private FSDataOutputStream create(Path f, Reporter reporter,
        FileStatus srcstat) throws IOException, MessageException, ServiceException {
     ...
     * @throws MessageException
     * @throws ServiceException */
    private void rename(Path tmp, Path dst) throws IOException, MessageException, ServiceException {
      try {
     ...
     * @throws MessageException
     */
    public void configure(JobConf job) throws MessageException
    {
 ...
 * @throws ServiceException
  ...
  static private void finalize(Configuration conf, JobConf jobconf,
      final Path destPath, String presevedAttributes) throws IOException, MessageException {
 ...
 * @throws MessageException
  ...
  /** Fully delete dir
 * @throws MessageException */
  static void fullyDelete(String dir, Configuration conf) throws IOException, MessageException {
    if (dir != null) {
 ...
 * @throws ServiceException */
  static private void checkDuplication(FileSystem fs, Path file, Path sorted,
    Configuration conf) throws IOException, MessageException, ServiceException {
    SequenceFile.Reader in = null;
    try {
