...
public class DistCh extends DistTool {
  ...
  static class FileOperation implements Writable {
    ...
    void run(Configuration conf) throws IOException, MessageException {
  ...
  private static void check(Configuration conf, List<FileOperation> ops
      ) throws InvalidInputException, MessageException {
  ...
  private boolean setup(List<FileOperation> ops, Path log) throws IOException, MessageException, ServiceException {
